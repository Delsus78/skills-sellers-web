            ...
            <div class="container">
                ...
                <div v-else>
                    ...
                    <div class="commun-text">
                        ...
                        <p>Vous avez pour l'instant <strong class="red">{{registreInfo.war.userAllies.length}}</strong> alliés</p>
                        <a v-if="authUser.id === registreInfo.war.userCreator.id && registreInfo.war.registreTarget"
                           class="meethicColored" @click="cancelWar">Tu peux annuler ici ta guerre.</a>
                    </div>
                </div>
            </div>
        </div>
